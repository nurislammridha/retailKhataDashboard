...
const DailySellAdd = () => {
    ...
    const [date, setDate] = useState(`${d.getFullYear()}-${twoDigit(d.getMonth() + 1)}-${twoDigit(d.getDate())}`)
    ...
    return (
        <>
            ...
            <div className='add'>
                ...
                <div className='input_cell'>
                    <h3>Current rate {quantity}X{presentPricePerUnit}={quantity * presentPricePerUnit}</h3>
                    <h3>{totalPrice - (quantity * presentPricePerUnit) > 0 ? "Profit" : "Loss"}={Math.abs(totalPrice - presentPricePerUnit * quantity)} Taka</h3>
